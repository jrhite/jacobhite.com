...
export const promotingLiteracySlides: SlideImage[] = [
  ...
  'Evidence that schoolwide literacy works — Concourse Village Elementary: daily collaborative read-alouds, one shared MACAS analysis protocol, literacy in every subject, and paired peer observation, reaching close to 90% proficiency.',
